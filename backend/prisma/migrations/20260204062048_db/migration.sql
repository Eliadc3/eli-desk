...
INSERT INTO "new_User" ("createdAt", "id", "name", "orgId", "passwordHash", "role", "techDepartmentId", "updatedAt") SELECT "createdAt", "id", "name", "orgId", "passwordHash", "role", "techDepartmentId", "updatedAt" FROM "User";
DROP TABLE "User";
